...
class Appr(object):
    ...
    def __init__(self,model,nepochs=100,sbatch=256,lr=0.05,lr_min=1e-4,lr_factor=3,
                 lr_patience=5,clipgrad=10000,lamb=0.75,smax=400,optim='Adam', split=False, data_name='pMNIST'):
        self.model=model
        ...
        self.file_name = 'HAT_lamb_{}_smax_{}_{}'.format(lamb, smax, data_name)      
    ...
    def train(self, t, x_train, y_train, x_valid, y_valid):
        best_acc=-np.inf
